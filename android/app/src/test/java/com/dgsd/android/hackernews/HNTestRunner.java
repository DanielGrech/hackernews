...
public class HNTestRunner extends RobolectricGradleTestRunner {
    ...
    public HNTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
        ...
        if (config == null) {
            ...
            return new DelegatingConfig(config) {
                ...
                public String packageName() {
                    ...
                    return HNTestRunner.class.getPackage().getName();
                }
