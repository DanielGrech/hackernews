...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private(set) lazy var dataSource : DataSource = {
        return DataSource(networkDataSource: NetworkDataSource())
    }()
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let window = window {
            ...
            window.rootViewController = MainDrawerController()
        ...
        UITabBarItem.appearance().setTitleTextAttributes([NSForegroundColorAttributeName : UIColor.accent], forState: UIControlState.Selected)
